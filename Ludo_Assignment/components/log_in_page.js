...
return(
  ...
  <View> 
  <Text style={styles.box1}>Talk</Text>
  <Text  style={styles.box2}>Smart , Private Messaging</Text>
  </View>
  ...
  <View> 
  <Text style={styles.box7}>path's terms of uses and privacy</Text>
  </View>
  <View> 
  <Text style={styles.box7}>policy.</Text>
  </View>
  <View> 
